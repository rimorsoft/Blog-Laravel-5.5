    ...
    <div class="row justify-content-md-center">
        ...
        <div class="card col-md-10 p-0 mb-5">
          <div class="card-header">
            Lista de Entradas <a type="button" href="{{ route('posts.create') }}" class="btn btn-success float-right">Crear</a>
          </div>
          <div class="card-body">
          ...
          <div class="card-footer text-muted">
            <div class="float-right"> {{ $posts->render('admin.partials.pagination') }} </div>
          </div>
        </div>
